...
def save_report():
    with open(os.path.join(OUT, "results_s1e.json"), "w", encoding="utf-8") as f:
        json.dump(results, f, ensure_ascii=False, indent=2, default=str)
    with open(os.path.join(OUT, "spike_s1e.log"), "w", encoding="utf-8") as f:
        f.write("\n".join(log_lines))
...
def main():
    ...
    try:
        ...
        try_ima("selview_marked", lambda: drw2.InsertModelAnnotations3(32768, 0x3FFFFFF, False, True, True, False))
        try_ima("selview_notmarked", lambda: drw2.InsertModelAnnotations3(524288, 0x3FFFFFF, False, True, True, False))
        try_ima("selview_dim8", lambda: drw2.InsertModelAnnotations3(8, 8, False, True, True, False))
        try_ima("selview_allviews_marked", lambda: drw2.InsertModelAnnotations3(32768, 0x3FFFFFF, True, True, True, False))
        ...
        out_png = os.path.join(OUT, "S1e-snapshot.png")
        t0 = time.time()
