...
> ⚠️ **部分废止（2026-08-02）**：本文档的 DXF 载体路线（ezdxf 自绘图纸）已废止，Step3/4/5/7 渲染层已归档至 `archive/2026-08-02-DXF路线/`。AI 决策思路仍有参考价值。现行方案见 `plans/08-方案B-SW原生SLDDRW改造设计.md` + `plans/09-项目总计划-0to1.md`。
