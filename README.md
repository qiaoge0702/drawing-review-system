...
| 文档 | 内容 |
|------|------|
| [plans/09-项目总计划-0to1](docs/plans/09-项目总计划-0to1.md) | **总纲**：P0-P7 阶段计划 + 复用清单 + 铁律 |
| [plans/08-方案B-SW原生SLDDRW改造设计](docs/plans/08-方案B-SW原生SLDDRW改造设计.md) | 技术设计：各步改造 + AI守门员 + 快照机制 |
